package org.xyp.shared.db.id.generator.table.impl;
...
public class LongIdDbTableGenerator implements IdGenerator<Long> {
    ...
    @Setter
    private List<BiConsumer<String, BatchIdResult>> recordFetchedPeeks = new ArrayList<>();
    @Setter
    private List<BiConsumer<String, BatchIdResult>> recordUpdatedPeeks = new ArrayList<>();
    @Setter
    private List<BiConsumer<String, BatchIdResult>> recordInitializedPeeks = new ArrayList<>();
