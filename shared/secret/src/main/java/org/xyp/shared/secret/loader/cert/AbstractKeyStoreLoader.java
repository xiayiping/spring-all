...
import org.xyp.shared.secret.loader.cert.model.SecretStoreBundle;
import org.xyp.shared.secret.loader.cert.model.SecretTuple;
...
public abstract class AbstractKeyStoreLoader<T> implements KeyStoreLoader {
    ...
    protected abstract SecretReader getReader(
    ...
    protected Map<String, SecretStoreBundle> readBundle(
            SecretReader client,
            KeyStoreSecretProperty.SecretPath sPath,
